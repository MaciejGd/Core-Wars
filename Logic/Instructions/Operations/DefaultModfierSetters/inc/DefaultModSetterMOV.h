...
/// operations MOV and CMP
class CDefaultModSetterMOV : public IDefaultModSetter {
public:
    CDefaultModSetterMOV(): IDefaultModSetter() {}
    CDefaultModSetterMOV(const CDefaultModSetterMOV& other): IDefaultModSetter(other) {};
